	...
	\begin{document}
		...
		\begin{enumerate}
			...
			%Ejercicio Número 1, de Dimensión
			...
			%Ejercicio Número 2, de Dimensión
		...
		\begin{enumerate}
			...
			%Ejercicio 5, de transfromaciónes lineales
			
			\item[] \(2.1_5\) 
			Determina cuáles de las siguientes aplicaciones \(F\) son lineales:
			
			%Inciso "a", del ejercicio 5 de transfrommaciónes lineales
			
			\item \(2.1_a\) 
			\(F: \mathbb{R}^3 \to \mathbb{R}^2\) definida por \(F(x,y,z)=(x,z)\)
			
			%Inciso "c", del ejercicio 5 de transfrommaciónes lineales
			...
			%Inciso "e", del ejercicio 5 de transfrommaciónes lineales
		...
		\begin{enumerate}
			...
			%Ejercicio 6, de transfromaciones lineales
			
			\item[] \(2.2_6\) Determina cuáles de las siguientes aplicaciones son lineales:
			
			%Inciso "a", del ejercicio 6, de transfromaciones lineales
			...
			%Inciso "c", del ejercicio 6, de transfromaciones lineales
			...
			%Inciso "d", del ejercicio 6, de transfromaciones lineales
		...
		\begin{enumerate}
			...
			%Ejercicio 7, de transformaciónes lineales
		...
		\begin{enumerate}
			...
			%Inciso "b" del ejercicio 8, de transformaciones lineales
		...
		\begin{enumerate}
			...
			%Ejercicio 10, de Núcleo e Imagen
		...
		\begin{enumerate}
			...
			%Ejercicio 11, de Núcleo e Imagen
		...
		\begin{enumerate}
			...
			%Ejercicio 16, de Núcleo e Imagen
		...
		\begin{enumerate}
			...
			%Ejercicio 18, Inciso "a" de Núcleo e Imagen
